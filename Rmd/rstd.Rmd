...
-   Improve parsing the XML file containing all the info. [AWS `ListObjects`](https://docs.aws.amazon.com/AmazonS3/latest/API/API_ListObjects.html#API_ListObjects_ResponseSyntax) only returns the newest 1'000 results and `<IsTruncated>true</IsTruncated>` indicates that there are more -\> Figure out how to fully retrieve this "paginated" XML!

    We can use [ListObjectsV2](https://docs.aws.amazon.com/AmazonS3/latest/API/API_ListObjectsV2.html) on the preview URL: <https://s3.amazonaws.com/rstudio-ide-build/?list-type=2>
